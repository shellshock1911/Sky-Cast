...
The motivation for this project is to add to the body of research that compares traditional statistical methods with deep learning techniques to time series forecasting. I will use the field of commercial aviation as my testing ground for comparing ARIMA, MLPs, and RNNS. From here on out, I'll simply refer to MLPs and RNNs as neural networks, for they are both members of this class of machine learning algorithms. To my knowledge, no public research that involves neural networks has been conducted in this area, although I'm sure major airlines themselves treat time series forecasting seriously within their organizations. It is my opinion that the question of which approach is "better" has not yet been answered conclusively. It may be that the proper choice of model is wholly dependent on the specific problem one is trying to solve, and that one should consider the various benefits and trade-offs of each approach before settling on a choice. To this end, I will also discuss the limitations and drawbacks of each model and comment on which aspects of problems validate or invalidate the use of certain approaches.
...
##### Figure 1
![image3](./images/dl-atl.png)

##### Figure 2
![image4](./images/r2_chart.png)
